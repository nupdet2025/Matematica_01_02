...
gdjs.Cena_9501Code.GDbtn_9595replayObjects1= [];
gdjs.Cena_9501Code.GDbtn_9595replayObjects2= [];
gdjs.Cena_9501Code.GDbtn_9595replayObjects3= [];
...
gdjs.Cena_9501Code.GDborboleta1Objects1= [];
gdjs.Cena_9501Code.GDborboleta1Objects2= [];
gdjs.Cena_9501Code.GDborboleta1Objects3= [];
gdjs.Cena_9501Code.GDborboleta2Objects1= [];
gdjs.Cena_9501Code.GDborboleta2Objects2= [];
gdjs.Cena_9501Code.GDborboleta2Objects3= [];
gdjs.Cena_9501Code.GDborboleta3Objects1= [];
gdjs.Cena_9501Code.GDborboleta3Objects2= [];
gdjs.Cena_9501Code.GDborboleta3Objects3= [];


gdjs.Cena_9501Code.asyncCallback19393332 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.2), (runtimeScene) => (gdjs.Cena_9501Code.asyncCallback19393332(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Cena_9501Code.asyncCallback19396612 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Cena_9501Code.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.2), (runtimeScene) => (gdjs.Cena_9501Code.asyncCallback19396612(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Cena_9501Code.asyncCallback19400660 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Cena_9501Code.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.2), (runtimeScene) => (gdjs.Cena_9501Code.asyncCallback19400660(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Cena_9501Code.asyncCallback19390020 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Cena_9501Code.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Cena_9501Code.asyncCallback19390020(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Cena_9501Code.asyncCallback19389900 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Cena_9501Code.localVariables);
...
for (const obj of gdjs.Cena_9501Code.GDbtn_9595errado_959501Objects1) asyncObjectsList.addObject("btn_errado_01", obj);
for (const obj of gdjs.Cena_9501Code.GDbtn_9595errado_959502Objects1) asyncObjectsList.addObject("btn_errado_02", obj);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Cena_9501Code.asyncCallback19389900(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Cena_9501Code.asyncCallback19400844 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Cena_9501Code.localVariables);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.Cena_9501Code.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Cena_9501Code.asyncCallback19400844(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Cena_9501Code.asyncCallback10293204 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Cena_9501Code.localVariables);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.Cena_9501Code.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Cena_9501Code.asyncCallback10293204(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Cena_9501Code.userFunc0x1408b78 = function GDJSInlineCode(runtimeScene) {
"use strict";
// Parameters
...
gdjs.Cena_9501Code.userFunc0x1408cf8 = function GDJSInlineCode(runtimeScene) {
"use strict";
// Parameters
...
gdjs.copyArray(runtimeScene.getObjects("btn_replay"), gdjs.Cena_9501Code.GDbtn_9595replayObjects1);
...
for (var i = 0, k = 0, l = gdjs.Cena_9501Code.GDbtn_9595replayObjects1.length;i<l;++i) {
    if ( gdjs.Cena_9501Code.GDbtn_9595replayObjects1[i].isVisible() ) {
        isConditionTrue_0 = true;
        gdjs.Cena_9501Code.GDbtn_9595replayObjects1[k] = gdjs.Cena_9501Code.GDbtn_9595replayObjects1[i];
        ++k;
    }
}
gdjs.Cena_9501Code.GDbtn_9595replayObjects1.length = k;
if (isConditionTrue_0) {
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Cena_9501Code.GDbtn_9595comecarObjects1.length;i<l;++i) {
...
/* Reuse gdjs.Cena_9501Code.GDbtn_9595replayObjects1 */
...
for(var i = 0, len = gdjs.Cena_9501Code.GDbtn_9595replayObjects1.length ;i < len;++i) {
    gdjs.Cena_9501Code.GDbtn_9595replayObjects1[i].hide();
}
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Cena_9501Code.GDbtn_9595replayObjects1.length;i<l;++i) {
    if ( gdjs.Cena_9501Code.GDbtn_9595replayObjects1[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.Cena_9501Code.GDbtn_9595replayObjects1[k] = gdjs.Cena_9501Code.GDbtn_9595replayObjects1[i];
        ++k;
    }
...
gdjs.Cena_9501Code.userFunc0x1408b78(runtimeScene);
...
gdjs.Cena_9501Code.userFunc0x1408cf8(runtimeScene);
...
gdjs.Cena_9501Code.GDbtn_9595replayObjects1.length = 0;
gdjs.Cena_9501Code.GDbtn_9595replayObjects2.length = 0;
gdjs.Cena_9501Code.GDbtn_9595replayObjects3.length = 0;
...
gdjs.Cena_9501Code.GDborboleta1Objects1.length = 0;
gdjs.Cena_9501Code.GDborboleta1Objects2.length = 0;
gdjs.Cena_9501Code.GDborboleta1Objects3.length = 0;
gdjs.Cena_9501Code.GDborboleta2Objects1.length = 0;
gdjs.Cena_9501Code.GDborboleta2Objects2.length = 0;
gdjs.Cena_9501Code.GDborboleta2Objects3.length = 0;
gdjs.Cena_9501Code.GDborboleta3Objects1.length = 0;
gdjs.Cena_9501Code.GDborboleta3Objects2.length = 0;
gdjs.Cena_9501Code.GDborboleta3Objects3.length = 0;
