...
gdjs.Cena_9505Code.GDborboleta1Objects1= [];
gdjs.Cena_9505Code.GDborboleta1Objects2= [];
gdjs.Cena_9505Code.GDborboleta1Objects3= [];
gdjs.Cena_9505Code.GDborboleta2Objects1= [];
gdjs.Cena_9505Code.GDborboleta2Objects2= [];
gdjs.Cena_9505Code.GDborboleta2Objects3= [];
gdjs.Cena_9505Code.GDborboleta3Objects1= [];
gdjs.Cena_9505Code.GDborboleta3Objects2= [];
gdjs.Cena_9505Code.GDborboleta3Objects3= [];


gdjs.Cena_9505Code.asyncCallback19276060 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.2), (runtimeScene) => (gdjs.Cena_9505Code.asyncCallback19276060(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Cena_9505Code.asyncCallback19279548 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Cena_9505Code.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.2), (runtimeScene) => (gdjs.Cena_9505Code.asyncCallback19279548(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Cena_9505Code.asyncCallback19283340 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Cena_9505Code.localVariables);
...
{for(var i = 0, len = gdjs.Cena_9505Code.GDbackgroundObjects3.length ;i < len;++i) {
    ...
    gdjs.Cena_9505Code.GDbtn_9595certoObjects3[i].deleteFromScene(runtimeScene);
}
for(var i = 0, len = gdjs.Cena_9505Code.GDbtn_9595errado_959501Objects3.length ;i < len;++i) {
    gdjs.Cena_9505Code.GDbtn_9595errado_959501Objects3[i].deleteFromScene(runtimeScene);
}
for(var i = 0, len = gdjs.Cena_9505Code.GDbtn_9595errado_959502Objects3.length ;i < len;++i) {
    gdjs.Cena_9505Code.GDbtn_9595errado_959502Objects3[i].deleteFromScene(runtimeScene);
}
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.Cena_9505Code.asyncCallback19283340(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Cena_9505Code.asyncCallback19282964 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Cena_9505Code.localVariables);
...
for (const obj of gdjs.Cena_9505Code.GDbtn_9595errado_959501Objects1) asyncObjectsList.addObject("btn_errado_01", obj);
for (const obj of gdjs.Cena_9505Code.GDbtn_9595errado_959502Objects1) asyncObjectsList.addObject("btn_errado_02", obj);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Cena_9505Code.asyncCallback19282964(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Cena_9505Code.userFunc0x9f1d00 = function GDJSInlineCode(runtimeScene) {
"use strict";
// Parameters
...
gdjs.Cena_9505Code.userFunc0xfe22e0 = function GDJSInlineCode(runtimeScene) {
"use strict";
// Parameters
...
gdjs.Cena_9505Code.userFunc0xfe2410 = function GDJSInlineCode(runtimeScene) {
"use strict";
// Parameters
...
gdjs.Cena_9505Code.userFunc0x9f1d00(runtimeScene);
...
gdjs.Cena_9505Code.userFunc0xfe22e0(runtimeScene);
...
gdjs.Cena_9505Code.userFunc0xfe2410(runtimeScene);
...
gdjs.Cena_9505Code.GDborboleta1Objects1.length = 0;
gdjs.Cena_9505Code.GDborboleta1Objects2.length = 0;
gdjs.Cena_9505Code.GDborboleta1Objects3.length = 0;
gdjs.Cena_9505Code.GDborboleta2Objects1.length = 0;
gdjs.Cena_9505Code.GDborboleta2Objects2.length = 0;
gdjs.Cena_9505Code.GDborboleta2Objects3.length = 0;
gdjs.Cena_9505Code.GDborboleta3Objects1.length = 0;
gdjs.Cena_9505Code.GDborboleta3Objects2.length = 0;
gdjs.Cena_9505Code.GDborboleta3Objects3.length = 0;
